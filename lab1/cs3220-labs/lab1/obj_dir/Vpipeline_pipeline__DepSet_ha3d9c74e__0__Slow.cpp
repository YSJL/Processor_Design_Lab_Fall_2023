...
VL_ATTR_COLD void Vpipeline_pipeline___eval_initial__TOP__pipeline(Vpipeline_pipeline* vlSelf) {
    ...
    // Body
    VL_READMEM_N(true, 32, 16384, 0, VL_CVT_PACK_STR_NW(15, Vpipeline__ConstPool__CONST_h518c388f_0)
...
VL_ATTR_COLD void Vpipeline_pipeline___ctor_var_reset(Vpipeline_pipeline* vlSelf) {
    ...
    VL_RAND_RESET_W(239, vlSelf->__PVT__my_DE_stage__DOT__DE_latch);
    ...
    VL_RAND_RESET_W(174, vlSelf->__PVT__my_AGEX_stage__DOT__AGEX_latch);
